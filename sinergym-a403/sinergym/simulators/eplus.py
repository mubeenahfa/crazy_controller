...
class EnergyPlus(object):
    ...
    def start(self,
        ...
        #Request PMV Variables after warmup is complete
        self.exchange.request_variable(self.energyplus_state, "Zone Thermal Comfort Fanger Model PMV", "TZ-A403 People")
        self.exchange.request_variable(self.energyplus_state, "Zone Thermal Comfort Fanger Model PPD", "TZ-A403 People")
        self.exchange.request_variable(self.energyplus_state, "Zone Thermal Comfort Clothing Value", "TZ-A403 People")
